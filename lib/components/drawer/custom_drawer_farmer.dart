...
class CustomDrawerFarmer extends StatefulWidget {
  const CustomDrawerFarmer({super.key});

  @override
  State<CustomDrawerFarmer> createState() => _CustomDrawerFarmerState();
}

class _CustomDrawerFarmerState extends State<CustomDrawerFarmer> {
